...
Controller::Controller(Timer *tmr,CurrentDriver *cdriver,uint8_t* address){
...
// 	this->setup_pwm();
// 	this->current_driver->init();
// 	this->rtc.initialize(FALSE);
// 	time_t now_t;
// 	struct tm now_tm;
// 	now_t=rtc.Now();
// 	gmtime_r(&now_t,&now_tm);
// 	this->auto_time.add_time(&now_tm,now_tm.tm_hour,now_tm.tm_min+1,now_tm.tm_sec,30);
// 	this->auto_time.add_time(&now_tm,now_tm.tm_hour,now_tm.tm_min+2,now_tm.tm_sec,30);
// 	sei();
}
...
// 	now_t=rtc.Now();
// 	gmtime_r(&now_t,&now_tm);
// 	this->auto_time.add_time(&now_tm,Auto2HR,Auto2Min,0,Auto2Duration);
}
...
// 		this->led_func[seq.blue_led+3]=&Controller::run_blue;
// 		this->led_func[seq.green_led+3]=&Controller::run_green;
